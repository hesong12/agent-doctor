...
def _draw_vector_pet(canvas: Any, snapshot: DisplaySnapshot, *, phase: float) -> None:
    ...
    # Face screen.
    canvas.create_rectangle(50, 72 - bob, 132, 119 - bob, fill="#3e769a", outline="#274a73", width=3)
    eye_color = "#aef5ff" if snapshot.state != "intervening" else "#ffffff"
...
class PetView: NSView {
    ...
    func drawFallbackVector(_ state: String, _ t: Double) {
        ...
        roundRect(50, 72 - lift, 82, 47, 13, color("#3e769a"), color("#274a73"), 3)
        let eye = state == "intervening" ? NSColor.white : color("#aef5ff")
